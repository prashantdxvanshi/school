...
<div className="min-h-screen w-full bg-gradient-to-r from-[#0f172a] via-[#1e293b] to-[#0f172a] py-12 px-6">
  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
    {allschool.length > 0 ? (
      allschool.map((school) => (
        ...
        >
          ...
          <div className="p-5 flex flex-col justify-between flex-1">
            ...
            <p className="text-gray-700 text-sm mb-1"><span className="font-medium">Address:</span> {school.address}</p>
            <p className="text-gray-700 text-sm mb-1"><span className="font-medium">City:</span> {school.city}</p>
            <p className="text-gray-700 text-sm mb-1"><span className="font-medium">State:</span> {school.state}</p>
            <p className="text-gray-700 text-sm mb-1"><span className="font-medium">Contact:</span> {school.contact}</p>
            <p className="text-gray-700 text-sm mb-4"><span className="font-medium">Email:</span> {school.email_id}</p>
      ...
      <p className="text-center text-gray-500 text-lg col-span-full">No schools available</p>
    )}
  </div>
</div>
